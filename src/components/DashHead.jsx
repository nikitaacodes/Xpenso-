  ...
  return (
    <div className="w-full flex flex-col ">
      <div className="text-xl font-bold text-black-800 flex flex-row justify-between my-2">
        ...
        <div className="pr-16 flex gap-4">
          <Link href={"reports/thismonth"}>
            <button className=" border-gray-300 border text-black px-2  py-1 text-[16px]  font-medium rounded-sm">
              This month
            </button>
          </Link>
      ...
      <div className="flex flex-row gap-4 my-7">
        <div className=" w-[200px] pr-4 pl-2 py-1 border-2  border-gray-400 rounded-sm">
